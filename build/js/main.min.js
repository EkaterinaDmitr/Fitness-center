...
var reviewWidth;
var reviewPosition;
var reviewCount = 1; // Определение ширины элементов в зависимости от экрана

var screenWidthDetection = function screenWidthDetection() {
  if (trainers) {
...
if (trainers) {
  // Предыдущий тренер
  var prevTrainerItem = function prevTrainerItem() {
  ...
  var nextTrainerItem = function nextTrainerItem() {
  ...
  trainerNext.addEventListener('click', nextTrainerItem); // Нажатия Enter на контролах
...
if (reviews) {
  // Предыдущий отзыв
  var prevReviewItem = function prevReviewItem() {
  ...
  var nextReviewItem = function nextReviewItem() {
  ...
  reviewsNext.addEventListener('click', nextReviewItem); // Нажатия Enter на контролах
