...
/*!********************!*\
  !*** ./js/main.js ***!
  \********************/
/*! exports provided: switchSwiper, switchSwiperReviews */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "switchSwiper", function() { return switchSwiper; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "switchSwiperReviews", function() { return switchSwiperReviews; });
...
/* harmony import */ var _vendor_swiper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/swiper */ "./js/vendor/swiper.js");
...
(function () {
  ...
  if (tabs) {
    var toggleTabs = function toggleTabs(event) {
      if (String(event.target.className) === 'tabs__link') {
        ...
        var tabBody = document.getElementsByClassName('tabs-body');
...
if (document.querySelector('.preview__play') && document.querySelector('.preview__video') && document.querySelector('.preview__image-container')) {
  var playButton = document.querySelector('.preview__play');
  var video = document.querySelector('.preview__video');
  var srcVideo = video.getAttribute('src');
  var imagePreview = document.querySelector('.preview__image-container');
...
var switchSwiper = function switchSwiper() {
...
var switchSwiperReviews = function switchSwiperReviews() {
